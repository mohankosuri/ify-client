  ...
  <div className='flex flex-wrap py-3.5 px-10 overflow-x-auto'>
    ...
    <div id="collapseMenu"
      ...
      <ul
        ...
        <li className='max-lg:border-b max-lg:py-3'><NavLink to={'/'}
            className='hover:text-[#007bff] text-gray-500 font-bold text-[15px] block'>Home</NavLink></li>
        <li className='max-lg:border-b max-lg:py-3'><NavLink to={'/team'}
            className='hover:text-[#007bff] text-gray-500 font-bold text-[15px] block'>Team</NavLink></li>
        
        <li className='max-lg:border-b max-lg:py-3'><NavLink  to={'/blog'}
            className='hover:text-[#007bff] text-gray-500 font-bold text-[15px] block'>Blog</NavLink></li>
        <li className='max-lg:border-b max-lg:py-3'><NavLink to={'/about'}
            className='hover:text-[#007bff] text-gray-500 font-bold text-[15px] block'>About</NavLink></li>
        <li className='max-lg:border-b max-lg:py-3'><NavLink to={'contact'}
            className='hover:text-[#007bff] text-gray-500 font-bold text-[15px] block'>Contact</NavLink></li>
